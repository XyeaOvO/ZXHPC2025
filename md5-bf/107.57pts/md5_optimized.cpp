...
#define FF(a, b, c, d, x, s, ac) { (a) = _mm256_add_epi32((a), F((b), (c), (d))); (a) = _mm256_add_epi32((a), (x)); (a) = _mm256_add_epi32((a), _mm256_set1_epi32(ac)); (a) = ROTATE_LEFT((a), (s)); (a) = _mm256_add_epi32((a), (b)); }
#define GG(a, b, c, d, x, s, ac) { (a) = _mm256_add_epi32((a), G((b), (c), (d))); (a) = _mm256_add_epi32((a), (x)); (a) = _mm256_add_epi32((a), _mm256_set1_epi32(ac)); (a) = ROTATE_LEFT((a), (s)); (a) = _mm256_add_epi32((a), (b)); }
#define HH(a, b, c, d, x, s, ac) { (a) = _mm256_add_epi32((a), H((b), (c), (d))); (a) = _mm256_add_epi32((a), (x)); (a) = _mm256_add_epi32((a), _mm256_set1_epi32(ac)); (a) = ROTATE_LEFT((a), (s)); (a) = _mm256_add_epi32((a), (b)); }
#define II(a, b, c, d, x, s, ac) { (a) = _mm256_add_epi32((a), I((b), (c), (d))); (a) = _mm256_add_epi32((a), (x)); (a) = _mm256_add_epi32((a), _mm256_set1_epi32(ac)); (a) = ROTATE_LEFT((a), (s)); (a) = _mm256_add_epi32((a), (b)); }
...
void md5_8x_48_byte(const uint64_t inputs[SIMD_WIDTH][6], uint32_t digests[SIMD_WIDTH][4]) {
    ...
    x[12] = _mm256_set1_epi32(0x80); x[13] = _mm256_setzero_si256();
    x[14] = _mm256_set1_epi32(384);  x[15] = _mm256_setzero_si256();
    ...
    A=_mm256_add_epi32(A,a); B=_mm256_add_epi32(B,b); C=_mm256_add_epi32(C,c); D=_mm256_add_epi32(D,d);
    alignas(32) uint32_t temp_A[8], temp_B[8], temp_C[8], temp_D[8];
    _mm256_store_si256((__m256i*)temp_A,A); _mm256_store_si256((__m256i*)temp_B,B);
    _mm256_store_si256((__m256i*)temp_C,C); _mm256_store_si256((__m256i*)temp_D,D);
